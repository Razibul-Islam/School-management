        ...
        <div>
                  ...
                  <div class="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                    <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-3">
                      <div class="mx-auto mb-12 text-center lg:mb-0">
                        <PublicIcon />
                        <h6 class="font-medium">ঢাকা,বাংলাদেশ</h6>
                      </div>
                      <div class="mx-auto mb-12 text-center lg:mb-0">
                        <LocationOnIcon />
                        <h6 class="font-medium">ঢাকা - ২৫৪৩</h6>
                      </div>
                      <div class="mx-auto mb-6 text-center md:mb-0">
                        <CallIcon />
                        <h6 class="font-medium">+৮৮০ ১২৩৪৫৬৭৮৯</h6>
                      </div>
                    </div>
          ...
          "
                        ...
                        <button
                          ...
                          class="inline-block w-full rounded mainBtn shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] lg:mb-0"
                        >
                          পাঠান
                        </button>
                      </form>
