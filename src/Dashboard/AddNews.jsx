...
const AddNews = () => {
    ...
    return (
        <div className='px-5 relative'>
            ...
            <button onClick={() => setModal('')} className='px-5 py-2 bg-teal-500 text-white rounded-3xl'>নতুন খবর যোগ করুন</button>
            ...
            <div class={`relative z-10 ${modal}`} aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="fixed inset-0 z-10 overflow-y-auto">
                    <form onSubmit={handleAddTeacher} class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <input className='block my-3 focus:outline-none border w-full p-2' type="text" name='title' placeholder='টাইটেল প্রবেশ করান' />
                                <input className='block my-3 focus:outline-none border w-full p-2' type="file" name='img' />
                                <textarea name="descripetion" placeholder='বর্ণনা দিন' className='block h-40 my-3 focus:outline-none border w-full p-2'></textarea>
                            </div>
