...
const Nine = () => {
    ...
    useEffect(() => {
        const url = 'https://school-server-razibul-islam.vercel.app/get-student?class_id=9';
        fetch(url)
            .then(res => res.json())
    ...
    return (
        <div className='p-5'>
            <h1 className='text-center text-xl my-5'>নবম শ্রেণির ছাত্র-ছাত্রীদের তালিকা</h1>
                        ...
                        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 grid grid-cols-2 gap-3">
                                ...
                                <select name='class' className='block my-3 focus:outline-none border w-full p-2'>
                                    ...
                                    <option selected value="নবম">নবম</option>
                                </select>
