...
const Saven = () => {
    ...
    const handleAddStudent = (e) => {
        ...
        const info = { name, role, yourClass, father_name, mother_name, date_of_birth, class_id };
        console.log(info);
    ...
    useEffect(() => {
        const url = 'https://school-server-liard.vercel.app/get-student?class_id=7';
        fetch(url)
            .then(res => res.json())
    ...
    return (
        <div className='p-5'>
            <h1 className='text-center text-xl my-5'>সপ্তম শ্রেণির ছাত্র-ছাত্রীদের তালিকা</h1>
