...
const Addnotice = () => {
  ...
  const handleAddStudent = (e) => {
    ...
    const url = `https://school-server-umber.vercel.app/add-notice`;
  ...
  const handleDeleteNotice = (_id) => {
    const url = `https://school-server-umber.vercel.app/delete-notice?_id=${_id}`;
    fetch(url, {
      method: "DELETE",
    })
      .then((res) => res.json())
  ...
  useEffect(() => {
    const url = "https://school-server-umber.vercel.app/get-notice";
    fetch(url)
      .then((res) => res.json())
            ...
            <div className="p-3 bg-slate-100 my-2">
              ...
              <div className="flex justify-between items-center my-3">
                <p className="text-sm text-teal-500">
                  {convertTimestampToDate(notices.time)}
                </p>
                <button
                  onClick={() => handleDeleteNotice(notices._id)}
            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                ...
                <textarea
                  required
                  name="prahgraph"
                  className="block my-3 focus:outline-none border w-full p-2 h-60"
