...
const SMC = () => {
  ...
  return (
    <div className="p-5 w-full relative">
      <h2 className="text-xl text-center my-5">এসএমসি তালিকা</h2>
      <button
        onClick={() => setModal("")}
        className="px-5 py-2 bg-teal-500 text-white rounded-3xl mb-5"
      >
        এসএমসি তথ্য যোগ করুন
      </button>
            ...
            return (
              <tr key={data._id}>
                ...
                <td className="flex gap-4 items-center">
                  <button
                    onClick={() => handledeleteSMC(data._id)}
                ...
                <td onClick={() => setCounsil_id(data?._id)}>
                  <button
                    onClick={() => setModalTwo("")}
                    className="bg-teal-500 text-white h-full w-full rounded-sm"
                  >
                    <AddIcon />
                  </button>
                </td>
              ...
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <option value="কে এইচ স্কুল ও কলেজ">
                      কে এইচ স্কুল ও কলেজ
                    </option>
                  </select>
                  <input
