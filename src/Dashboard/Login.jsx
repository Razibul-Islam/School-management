  ...
  const handleLogin = (e) => {
    ...
    if (user_id === "123456" && password === "password") {
      localStorage.setItem(
        "user",
        "6fjk36djkt4576fh4rf7tf34h47ft4rtgf643r43r6frfee3dr5def3dre53f36543frr53re623f"
      );
      navigate("/admin");
      ...
      <div className="w-96 p-5 border shadow">
        ...
        <form onSubmit={handleLogin} className="mt-5">
          <input
            ...
            type="text"
            placeholder="ইউজার আইডি প্রবেশ করান"
            name="userId"
          />
          <input
            className="block my-3 focus:outline-none border w-full p-2"
            ...
            name="password"
          />
          <button className="bg-gradient-to-t from-teal-500 to-green-600 text-white px-5 py-2">
            লগইন করুন
          </button>
        </form>
      </div>
